...
class Cache
{
	 ...
	 */
	public function __construct( CacheInterface $storage, $options = array() ) {
	...
	public function __invoke( callable $next ) {
		return function ( RequestInterface $request, array $options ) use ( $next ) {
			...
			if ( $ttl && $response = $this->storage->get( $key, null ) ) {
	 ...
	 */
	public function getKey( RequestInterface $request, $sep = '|' ) {
		$filter = $this->options->headers ?? array();
